    ...
    >
      ...
      >
        ...
        <div className="relative p-16 text-center text-gray-800 dark:text-gray-100 glass hover:-translate-y-3 hover:shadow-3xl transition-all duration-500">
          ...
          {/* Enhanced button — guaranteed clickable */}
          <motion.label
            htmlFor="file-upload"
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.7 }}
            className="relative z-30 inline-block px-12 py-6 bg-gradient-to-r from-amber-600 to-orange-600 rounded-full text-2xl font-bold cursor-pointer hover:from-amber-700 hover:to-orange-700 hover:scale-105 transition-all shadow-2xl text-white pointer-events-auto"
          >
            <input
              id="file-upload"
              type="file"
      ...
      {/* Light mode */}
      <div className="absolute top-20 left-20 w-96 h-96 bg-amber-200 rounded-full filter blur-3xl opacity-30 animate-pulse slow" />
